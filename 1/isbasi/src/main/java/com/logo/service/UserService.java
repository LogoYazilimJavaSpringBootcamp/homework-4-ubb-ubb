...
import com.logo.producer.UserProducer;
...
public class UserService {
	...
	public User createUser(User request) {
		...
		userProducer.sendToQueue(request);

		//rabbitTemplate.convertAndSend("isbasi.email", request.getName());

		//rabbitTemplate.convertAndSend("isbasi.email",request.getAddress());
